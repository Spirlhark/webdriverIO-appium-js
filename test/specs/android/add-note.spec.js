...
describe('Add Notes', () => {
    ...
    xit('skip tutorial', async () => {
        ...
        // await $('//*[@resource-id="ua.ideabank.obank:id/button"]').click();
        ...
        await $('//*[@resource-id="ua.ideabank.obank:id/editText"]').addValue("1231234567");

        //assertion
        await expect($('android=new UiSelector().textContains("Не вірний формат номеру")')).toBeDisplayed();
